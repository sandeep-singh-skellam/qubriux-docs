...
### For Milestone-Based Challenges
...
**Streak action**
What the customer must do in each period to keep their streak alive. For example: place any order, make a purchase above a certain amount, or visit in-store.
...
**Streak reward**
The reward delivered when the customer reaches their target and completes the streak. Like milestone rewards, you can award loyalty points, a badge, an offer, or any combination.
...
**Participation limit**
The maximum number of times any single customer can complete this challenge. Leave blank for unlimited. Setting a limit prevents customers from repeatedly completing a well-rewarded challenge.

**Rejoin after completion (days)**
If you want customers to be able to complete the challenge more than once, set a waiting period before they can rejoin. For example, a 7-day rejoin window means a customer who finishes on day 1 can start again on day 8.
...
Review all settings carefully before activating. Once a challenge is active, core structural changes (challenge type, milestone conditions) are not possible.
...
You can manually deactivate a challenge before its end date. This immediately stops new enrolments and freezes all in-progress customer statuses. Customers who had already completed the challenge keep their rewards.
...
| **Deactivated** | Manually stopped before end date |
