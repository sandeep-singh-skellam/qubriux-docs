...
Qubriux Wallet is a flexible, multi-ledger digital wallet system designed for loyalty programs, cashback, store credit, and promotional balances.  
It provides brands with granular control over how value is earned, stored, and spent.
Qubriux Wallet allows each customer to have multiple wallet **ledgers**, such as:
- Cashback  
- Loyalty points  
- Promotional credits  
- Tier-based reward balances  

Each ledger has its own:
- Validity period  
- Deduction priority  
- Purpose or use case  
- Reporting category (called **Topics**)  

This gives brands complete flexibility in designing modern loyalty and rewards systems.
