...
The **Overall** view shows aggregate performance metrics for a selected channel and time period:

| Metric | Description |
|--------|-------------|
| Sent | Total messages dispatched |
| Delivered | Messages that reached the recipient |
| Opened | Messages opened by the recipient |
| Clicked | Recipients who clicked a link in the message |
| Failed | Messages that could not be delivered |

Switch between **Email**, **SMS**, **WhatsApp**, and **Push Notification** tabs to see the same metrics for each channel independently.

## Campaign & Journey Breakdown
...
The **Click Performance** report shows which links within your communications were clicked most, broken down by URL and click count. This helps you understand which calls-to-action are resonating with your audience.
